...
const getTradeSizeInfo = async (req, res) => {
    const query = 'SELECT DISTINCT size FROM jipsa.tradeInfo WHERE gu = ? AND dong = ? AND jibun = ?;';
...
const getRentSizeInfo = async (req, res) => {
    const query = 'SELECT DISTINCT size FROM jipsa.rentInfo WHERE gu = ? AND dong = ? AND jibun = ?;';

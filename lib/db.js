...
const getTradeInfo = async (req, res) => {
    const query = 'SELECT TRIM(year), TRIM(month), TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), TRIM(size), TRIM(tradePrice) FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? AND TRIM(jibun) = ?;';
...
const getRentInfo = async (req, res) => {
    const query = 'SELECT TRIM(year), TRIM(month), TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), TRIM(size), TRIM(rentPrice) FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? AND TRIM(jibun) = ?;';
...
const getTradeInfoByDong = async (req, res) => {
    const query = 'SELECT TRIM(year), TRIM(month), TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), TRIM(size), TRIM(tradePrice) FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ?;';
...
const getRentInfoByDong = async (req, res) => {
    const query = 'SELECT TRIM(year), TRIM(month), TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), TRIM(size), TRIM(rentPrice) FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ?;';
...
const getLeastTradeByDong = async (req, res) => {
    const query = 'SELECT TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(tradePrice) AS tradePrice, MAX(created) AS created FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? GROUP BY name, gu, dong, jibun;';
...
const getLeastRentByDong = async (req, res) => {
    const query = 'SELECT TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(rentPrice) AS rentPrice, MAX(created) AS created FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? GROUP BY name, gu, dong, jibun;';
...
const getLeastTradeByGu = async (req, res) => {
    const query = 'SELECT name, gu, TRIM(dong), jibun, MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(tradePrice) AS tradePrice, MAX(created) AS created FROM jipsa.tradeInfo WHERE TRIM(gu) = ? GROUP BY name, gu, dong, jibun;';

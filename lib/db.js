...
const getTradeInfo = async (req, res) => {
    const query = 'SELECT TRIM(year) AS year, TRIM(month) AS month, TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, size, tradePrice FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? AND TRIM(jibun) = ?;';

    const gu = req.query.gu.trim();
...
const getRentInfo = async (req, res) => {
    const query = 'SELECT TRIM(year) AS year, TRIM(month) AS month, TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, size, rentPrice  FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? AND TRIM(jibun) = ?;';
...
const getTradeInfoByDong = async (req, res) => {
    const query = 'SELECT TRIM(year) AS year, TRIM(month) AS month, TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, size, tradePrice FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ?;';
...
const getRentInfoByDong = async (req, res) => {
    const query = 'SELECT TRIM(year) AS year, TRIM(month) AS month, TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, size, rentPrice FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ?;';
...
const getLeastTradeByDong = async (req, res) => {
    const query = 'SELECT TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(tradePrice) AS tradePrice, MAX(created) AS created FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? GROUP BY name, gu, dong, jibun;';
...
const getLeastRentByDong = async (req, res) => {
    const query = 'SELECT TRIM(name) AS name, TRIM(gu) AS gu, TRIM(dong) AS dong, TRIM(jibun) AS jibun, MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(rentPrice) AS rentPrice, MAX(created) AS created FROM rentInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? GROUP BY name, gu, dong, jibun;';
...
const getLeastTradeByGu = async (req, res) => {
    const query = 'SELECT name, gu, TRIM(dong) AS dong, jibun, MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(tradePrice) AS tradePrice, MAX(created) AS created FROM jipsa.tradeInfo WHERE TRIM(gu) = ? GROUP BY name, gu, dong, jibun;';
...
const getLeastRentByGu = async (req, res) => {
    const query = 'SELECT name, gu, TRIM(dong) AS dong, jibun, MAX(size) AS size, MAX(year) AS year, MAX(month) AS month, MAX(rentPrice) AS rentPrice, MAX(created) AS created FROM jipsa.rentInfo WHERE TRIM(gu) = ? GROUP BY name, gu, dong, jibun;';

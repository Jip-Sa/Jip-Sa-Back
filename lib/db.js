...
const getTradeInfo = async (req, res) => {
    const query = 'SELECT TRIM(year), TRIM(month), TRIM(name), TRIM(gu), TRIM(dong), TRIM(jibun), size, tradePrice FROM tradeInfo WHERE TRIM(gu) = ? AND TRIM(dong) = ? AND TRIM(jibun) = ?;';
